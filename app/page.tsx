...
export default function Home() {
  ...
  return (
    <main>
      ...
      <section className="impact-strip" aria-label="BBK impact metrics"><div className="container-wide impact-grid"><div><strong>{settings?.impact_people_impacted ?? "1k+"}</strong><span>people impacted</span></div><div><strong>{settings?.impact_youth_trained ?? "30+"}</strong><span>youth trained</span></div><div><strong>{settings?.impact_satisfaction_rate ?? "98%"}</strong><span>satisfaction rate</span></div></div></section>
